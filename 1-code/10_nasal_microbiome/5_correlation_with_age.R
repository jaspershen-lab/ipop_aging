...
###load("data)
load(
  "3-data_analysis/nasal_microbiome/data_preparation/object_cross_section"
)
load(
  "3-data_analysis/nasal_microbiome/data_preparation/object_cross_section_loess"
)

dir.create(
  "3-data_analysis/nasal_microbiome/correlation_with_age/cross_section/",
  recursive = TRUE
)

dir.create(
  "3-data_analysis/nasal_microbiome/correlation_with_age/cross_section_loess/",
  recursive = TRUE
)

setwd("3-data_analysis/nasal_microbiome/correlation_with_age")
...
setdiff(rownames(object_cross_section_loess),
rownames(object_cross_section))

object_cross_section <-
  object_cross_section[rownames(object_cross_section_loess),]

####trans to relative intensity
colSums(object_cross_section_loess) %>%
  plot()
