...
dir.create("3-data_analysis/nasal_microbiome/data_preparation/same_samples", recursive = TRUE)
setwd("3-data_analysis/nasal_microbiome/data_preparation/same_samples")
