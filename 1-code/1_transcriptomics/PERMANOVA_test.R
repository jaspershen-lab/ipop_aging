...
dir.create("3-data_analysis/plasma_transcriptome/linear_spearman/cross_section/",
           recursive = TRUE)

setwd("3-data_analysis/plasma_transcriptome/linear_spearman/cross_section")
...
performance$measures$Q2.total$values
# see summary over repeats
performance$measures$Q2.total$summary
# Q2 total should decrease until it reaches a threshold
performance$measures$Q2.total
