...
dir.create(
  "3-data_analysis/clinical_test/fuzzy_c_means_clustering/cross_section_loess",
  recursive = TRUE
)

setwd("3-data_analysis/clinical_test/fuzzy_c_means_clustering/cross_section_loess")
