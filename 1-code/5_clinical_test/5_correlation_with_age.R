...
###load("data)
load(
  "3-data_analysis/clinical_test/data_preparation/object_cross_section"
)
load(
  "3-data_analysis/clinical_test/data_preparation/object_cross_section_loess"
)

dir.create(
  "3-data_analysis/clinical_test/correlation_with_age/cross_section/",
  recursive = TRUE
)

dir.create(
  "3-data_analysis/clinical_test/correlation_with_age/cross_section_loess/",
  recursive = TRUE
)

setwd("3-data_analysis/clinical_test/correlation_with_age")
