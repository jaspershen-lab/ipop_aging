...
dir.create("3-data_analysis/clinical_test/DEG/cross_section_loess/",
           recursive = TRUE)

setwd("3-data_analysis/clinical_test/DEG/cross_section_loess")
...
plot1 <-
  ...
  labs(x = "", y = "") +
  scale_fill_manual(values = c("changed" = unname(omics_color["clinical_test"]),
                               "no" = "grey")) +
