...
dir.create(
  "3-data_analysis/plasma_metabolomics/correlation_with_age/cross_section/",
  recursive = TRUE
)

dir.create(
  "3-data_analysis/plasma_metabolomics/correlation_with_age/cross_section_loess/",
  recursive = TRUE
)

setwd("3-data_analysis/plasma_metabolomics/correlation_with_age")
