...
dir.create(
  "3-data_analysis/plasma_metabolomics/data_preparation/metabolite/same_samples",
  recursive = TRUE
)
setwd("3-data_analysis/plasma_metabolomics/data_preparation/metabolite/same_samples")
