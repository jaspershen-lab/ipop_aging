...
load(
  "3-data_analysis/plasma_metabolomics/data_preparation/metabolite/object_cross_section_loess"
)
metabolomics_object <- object_cross_section_loess

load("3-data_analysis/plasma_cytokine/data_preparation/object_cross_section_loess")
cytokine_object <- object_cross_section_loess

load("3-data_analysis/clinical_test/data_preparation/object_cross_section_loess")
...
load("3-data_analysis/skin_microbiome/data_preparation/object_cross_section_loess")
skin_microbiome_object <- object_cross_section_loess

load("3-data_analysis/oral_microbiome/data_preparation/object_cross_section_loess")
...
dir.create("3-data_analysis/combined_omics/data_preparation/cross_section_loess",
           recursive = TRUE)

setwd("3-data_analysis/combined_omics/data_preparation/cross_section_loess")
