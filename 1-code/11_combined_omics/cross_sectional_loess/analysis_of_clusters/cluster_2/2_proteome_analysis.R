...
setwd(
  "3-data_analysis/combined_omics/fuzzy_c_means_clustering/cross_section_loess/cluster_2/proteomics_pathway/"
)
...
cluster2_proteomics <-
  final_cluster_info %>%
  dplyr::filter(cluster == 2 & class == "proteomics")
