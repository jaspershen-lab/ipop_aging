...
setwd(
  "3-data_analysis/combined_omics/fuzzy_c_means_clustering/cross_section_loess/cluster_2/lipidomics_pathway/"
)
...
cluster2_lipidomics <-
  final_cluster_info %>%
  dplyr::filter(cluster == 2 & class == "lipidomics")

dim(cluster2_lipidomics)

cluster2_lipidomics$mol_name
cluster2_lipidomics$variable_id
cluster2_lipidomics$test_name
