...
setwd(
  "3-data_analysis/combined_omics/fuzzy_c_means_clustering/cross_section_loess/cluster_5/cytokine_pathway/"
)
...
cluster5_cytokine <-
  final_cluster_info %>%
  dplyr::filter(cluster == 5 & class == "cytokine")
dim(cluster5_cytokine)

cluster5_cytokine$mol_name
