...
setwd(
  "3-data_analysis/combined_omics/fuzzy_c_means_clustering/cross_section_loess/cluster_5/proteomics_pathway/"
)
...
cluster5_proteomics <-
  final_cluster_info %>%
  dplyr::filter(cluster == 5 & class == "proteomics")

dim(cluster5_proteomics)
