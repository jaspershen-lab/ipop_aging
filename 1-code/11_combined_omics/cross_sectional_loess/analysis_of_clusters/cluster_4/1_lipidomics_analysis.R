...
setwd(
  "3-data_analysis/combined_omics/fuzzy_c_means_clustering/cross_section_loess/cluster_4/lipidomics_pathway/"
)
...
cluster4_lipidomics <-
  final_cluster_info %>%
  dplyr::filter(cluster == 4 & class == "lipidomics")

dim(cluster4_lipidomics)

cluster4_lipidomics$mol_name
cluster4_lipidomics$variable_id
cluster4_lipidomics$test_name
