...
setwd(
  "3-data_analysis/combined_omics/fuzzy_c_means_clustering/cross_section_loess/cluster_4/cytokine_pathway/"
)
...
cluster4_cytokine <-
  final_cluster_info %>%
  dplyr::filter(cluster == 4 & class == "cytokine")
dim(cluster4_cytokine)

cluster4_cytokine$mol_name
