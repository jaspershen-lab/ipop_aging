...
setwd(
  "3-data_analysis/combined_omics/fuzzy_c_means_clustering/cross_section_loess/cluster_4/proteomics_pathway/"
)
...
cluster4_proteomics <-
  final_cluster_info %>%
  dplyr::filter(cluster == 4 & class == "proteomics")

dim(cluster4_proteomics)
