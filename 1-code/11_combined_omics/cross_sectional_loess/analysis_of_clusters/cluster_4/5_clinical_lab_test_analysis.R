...
setwd(
  "3-data_analysis/combined_omics/fuzzy_c_means_clustering/cross_section_loess/cluster_4/clinical_test_pathway/"
)
...
###cluster 4
cluster4_clinical_test <-
  final_cluster_info %>%
  dplyr::filter(cluster == 4 & class == "clinical_test")

dim(cluster4_clinical_test)

cluster4_clinical_test$mol_name
cluster4_clinical_test$variable_id
cluster4_clinical_test$test_name
