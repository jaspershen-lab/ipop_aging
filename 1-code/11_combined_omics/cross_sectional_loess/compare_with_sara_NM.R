...
sara_result <-
  readxl::read_xlsx(
    "3-data_analysis/sara_NM/41591_2019_719_MOESM2_ESM.xlsx",
    sheet = 1,
    skip = 3
  )
...
load(
  "3-data_analysis/combined_omics/fuzzy_c_means_clustering/cross_section_loess/cor_data"
)
...
dir.create("3-data_analysis/sara_NM/compare")
setwd("3-data_analysis/sara_NM/compare")
