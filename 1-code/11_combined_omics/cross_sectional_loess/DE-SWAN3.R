...
# )
# 
# dir.create("3-data_analysis/combined_omics/DE_SWAN3")
# setwd("3-data_analysis/combined_omics/DE_SWAN3")
# 
# # library("DEswan")
# 
...
# 
# sample_number <-
#   1:length(seq(40, 65, 1)) %>% 
#   purrr::map(function(i){
#     data.frame(left = (seq(40, 65, 1) - 5)[i],
#                middle = seq(40, 65, 1)[i],
#                right = (seq(40, 65, 1) + 5)[i],
#                left_number = sum(sample_info$age >= (seq(40, 65, 1) - 5)[i] &
#                                    sample_info$age < seq(40, 65, 1)[i]),
#                right_number = sum(sample_info$age > seq(40, 65, 1)[i] &
#                                     sample_info$age <= (seq(40, 65, 1) + 5)[i]))
#   }) %>% 
#   do.call(rbind, .) %>% 
#   as.data.frame()
# 
# plot(sample_number$middle, sample_number$left_number + sample_number$right_number)
# plot(sample_number$middle, sample_number$right_number)
# 
# seq(40, 65, 1) - 5
# seq(40, 65, 1) 
# seq(40, 65, 1) + 5
...
# # temp_data <-
# #   do_se_swan(
# #     object = object_cross_section_loess,
# #     qt = "age",
