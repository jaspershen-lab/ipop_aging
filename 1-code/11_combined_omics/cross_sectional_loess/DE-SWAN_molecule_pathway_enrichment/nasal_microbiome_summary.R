...
dir.create("3-data_analysis/combined_omics/DE_SWAN/nasal_microbiome_summary")
...
temp_data <-
  temp_data_nasal_microbiome_crest1 %>%
  dplyr::full_join(temp_data_nasal_microbiome_crest2, by = "variable_id") %>%
...
ggsave(plot, file = "nasal_microbiome_summary/sankey_plot.pdf", width = 7, height = 5)
