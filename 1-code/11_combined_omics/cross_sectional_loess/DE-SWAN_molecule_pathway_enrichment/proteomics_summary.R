...
dir.create("3-data_analysis/combined_omics/DE_SWAN/proteomics_summary")
...
edge_data <-
  ...
  dplyr::filter(annotation1 == annotation2)
...
ggsave(plot, filename = "proteomics_summary/top20_pathways.pdf", width = 2, height = 7)
