...
dir.create("3-data_analysis/combined_omics/DE_SWAN/oral_microbiome_summary")
...
####crest 2
temp_data_oral_microbiome_crest2 <-
  temp_data_oral_microbiome %>%
...
temp_data <-
  temp_data_oral_microbiome_crest1 %>%
  dplyr::full_join(temp_data_oral_microbiome_crest2, by = "variable_id") %>%
...
ggsave(plot, file = "oral_microbiome_summary/sankey_plot.pdf", width = 7, height = 5)
