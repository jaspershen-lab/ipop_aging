...
dir.create("3-data_analysis/combined_omics/DE_SWAN/skin_microbiome_summary")
...
temp_data <-
  temp_data_skin_microbiome_crest1 %>%
  dplyr::full_join(temp_data_skin_microbiome_crest2, by = "variable_id") %>%
...
ggsave(plot, file = "skin_microbiome_summary/sankey_plot.pdf", width = 7, height = 5)
