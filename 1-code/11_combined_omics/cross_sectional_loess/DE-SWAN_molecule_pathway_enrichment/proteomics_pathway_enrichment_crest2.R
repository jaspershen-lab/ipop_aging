...
####proteomics
dir.create("proteomics_pathway_crest2")
dir.create("proteomics_pathway_crest2/GO_result/")
dir.create("proteomics_pathway_crest2/KEGG_result/")
dir.create("proteomics_pathway_crest2/Reactome_result/")

####crest2
temp_data_proteomics_crest2 <-
  temp_data_proteomics %>%
...
###GO enrichment
# proteomics_crest2_go <-
#   enrichGO(
#     gene = temp_data_proteomics_crest2$ENTREZID[!is.na(temp_data_proteomics_crest2$ENTREZID)],
#     OrgDb = org.Hs.eg.db,
#     keyType = "ENTREZID",
#     ont = "ALL",
#     pvalueCutoff = 0.05,
...
# save(proteomics_crest2_go, file = "proteomics_pathway_crest2/GO_result/proteomics_crest2_go")
load("proteomics_pathway_crest2/GO_result/proteomics_crest2_go")


#enrichment KEGG analysis
# proteomics_crest2_kegg <-
#   enrichKEGG(
#     gene = temp_data_proteomics_crest2$UNIPROT[!is.na(temp_data_proteomics_crest2$UNIPROT)],
#     organism = "hsa",
#     keyType = "uniprot",
#     pvalueCutoff = 0.05,
#     pAdjustMethod = "fdr",
...
#   dplyr::filter(p.adjust < 0.05)
# 
# result <- proteomics_crest2_kegg@result
# 
# kegg_class <-
#   purrr::map(
#     .x = result$ID,
...
#   unlist()
# 
# proteomics_crest2_kegg@result$kegg_class <- kegg_class
# 
# save(proteomics_crest2_kegg, file = "proteomics_pathway_crest2/KEGG_result/proteomics_crest2_kegg")
load("proteomics_pathway_crest2/KEGG_result/proteomics_crest2_kegg")

# ##reactome pathway enrichment
# library(ReactomePA)
# proteomics_crest2_reactome <-
#   ReactomePA::enrichPathway(gene = temp_data_proteomics_crest2$ENTREZID[!is.na(temp_data_proteomics_crest2$ENTREZID)],
#                             organism = "human",
#                             pvalueCutoff = 0.05,
#                             pAdjustMethod = "fdr",
#                             qvalueCutoff = 0.05)
...
# disease <-
#   purrr::map(proteomics_crest2_reactome@result$ID, function(x) {
...
#   unlist()
# 
# proteomics_crest2_reactome@result$disease <-
#   disease
# 
# save(proteomics_crest2_reactome, file = "proteomics_pathway_crest2/Reactome_result/proteomics_crest2_reactome")
...
###KEGG
load("proteomics_pathway_crest2/KEGG_result/proteomics_crest2_kegg")
if(!is.null(proteomics_crest2_kegg)){
  proteomics_crest2_kegg <-
    proteomics_crest2_kegg@result %>%
    dplyr::filter(p.adjust < 0.05) %>%
    dplyr::arrange(p.adjust) %>%
...
# go_sim_matrix =
#   get_go_result_sim(result = proteomics_crest2_go, sim.cutoff = 0)
# 
# save(go_sim_matrix, file = "proteomics_pathway_crest2/GO_result/go_sim_matrix")

load("proteomics_pathway_crest2/GO_result/go_sim_matrix")
...
#                                                            "sim")))
# 
# save(subnetwork, file = "proteomics_pathway_crest2/GO_result/subnetwork")
load("proteomics_pathway_crest2/GO_result/subnetwork")
...
# )
# 
# saveWorkbook(wb, "proteomics_pathway_crest2/GO_result/result_go.xlsx", overwrite = TRUE)
...
# ggplot2::ggsave(plot,
#        filename =
#          "proteomics_pathway_crest2/GO_result/GO_sim_plot.pdf",
#        width = 7,
#        height = 7)

dir.create("proteomics_pathway_crest2/GO_result/GO_sim_plot")
...
#     plot,
#     filename = file.path(
#       "proteomics_pathway_crest2/GO_result/GO_sim_plot",
...
#     width = 16,
#     height = 14,
#     path = "proteomics_pathway_crest2/GO_result",
#     top = 15
#   )
# }
...
# )
# 
# saveWorkbook(wb, "proteomics_pathway_crest2/GO_result/result_go_cluster.xlsx", overwrite = TRUE)

###output the cluster annotation for each cluster
dir.create("proteomics_pathway_crest2/GO_result/GO_graph")
...
#         plot,
#         filename = file.path(
#           "proteomics_pathway_crest2/GO_result/GO_graph",
...
# if(!is.null(proteomics_crest2_kegg)){
#   kegg_sim_matrix <-
#     simplifyEnrichment::term_similarity_from_KEGG(term_id = c(proteomics_crest2_kegg$ID),
#                                                   method = "jaccard") %>%
#     as.data.frame() %>%
...
# }
# 
# save(kegg_sim_matrix, file = "proteomics_pathway_crest2/KEGG_result/kegg_sim_matrix")

load("proteomics_pathway_crest2/KEGG_result/kegg_sim_matrix")
...
# save(result_kegg, file = "proteomics_pathway_crest2/KEGG_result/result_kegg")
load("proteomics_pathway_crest2/KEGG_result/result_kegg")
...
# ggsave(plot,
#        filename = "proteomics_pathway_crest2/KEGG_result/kegg_sim_plot.pdf",
#        width = 9,
#        height = 7)


dir.create("proteomics_pathway_crest2/KEGG_result/KEGG_sim_plot")
...
#     plot,
#     filename = file.path(
#       "proteomics_pathway_crest2/KEGG_result/KEGG_sim_plot",
#       paste(temp_cluster, "sim_plot.pdf", sep = "_")
#     ),
#     width = 21,
#     height = 7
...
# )
#
# saveWorkbook(wb, "proteomics_pathway_crest2/KEGG_result/result_kegg_cluster.xlsx", overwrite = TRUE)
...
# reactome_sim_matrix <-
#   tryCatch(
#     expr =  simplifyEnrichment::term_similarity_from_Reactome(term_id = c(proteomics_crest2_reactome$ID),
#                                                                method = "jaccard") %>%
#       as.data.frame() %>%
#       tibble::rownames_to_column(var = "name1") %>%
#       tidyr::pivot_longer(
...
#   )
# 
# save(reactome_sim_matrix, file = "proteomics_pathway_crest2/Reactome_result/reactome_sim_matrix")

load("proteomics_pathway_crest2/Reactome_result/reactome_sim_matrix")
...
node_data <-
  rbind(proteomics_crest2_reactome) %>%
  as.data.frame() %>%
  dplyr::select(ID, everything()) %>%
  dplyr::rename(node = ID)
...
#   dplyr::arrange(p.adjust)
# 
# save(result_reactome, file = "proteomics_pathway_crest2/Reactome_result/result_reactome")
load("proteomics_pathway_crest2/Reactome_result/result_reactome")
...
# )
# 
# saveWorkbook(wb, "proteomics_pathway_crest2/Reactome_result/result_reactome.xlsx", overwrite = TRUE)
...
# ggsave(plot,
#        filename =
#          "proteomics_pathway_crest2/Reactome_result/Reactome_sim_plot.pdf",
#        width = 8.5,
#        height = 7)

dir.create("proteomics_pathway_crest2/Reactome_result/Reactome_sim_plot")
...
#     plot,
#     filename = file.path(
#       "proteomics_pathway_crest2/Reactome_result/Reactome_sim_plot",
#       paste(temp_cluster, "sim_plot.pdf", sep = "_")
#     ),
#     width = 21,
#     height = 7
...
#   width = 16,
#   height = 12,
#   path = "proteomics_pathway_crest2/Reactome_result"
# )
...
# saveWorkbook(
#   wb,
#   "proteomics_pathway_crest2/Reactome_result/result_reactome_cluster.xlsx",
#   overwrite = TRUE
# )
...
result_go_cluster <-
  rbind(
    readxl::read_xlsx(
      "proteomics_pathway_crest2/GO_result/result_go_cluster.xlsx",
      sheet = 1
    ) %>%
...
saveWorkbook(wb,
             "proteomics_pathway_crest2/KEGG_result/result_kegg_cluster.xlsx",
             overwrite = TRUE)
...
# save(result_all, file = "proteomics_pathway_crest2/result_all")
...
# )
# 
# saveWorkbook(wb, "proteomics_pathway_crest2/result_all.xlsx", overwrite = TRUE)
...
ggsave(plot,
       filename = "proteomics_pathway_crest2/GO_KEGG_Reactome_sim_plot.pdf",
       width = 6,
       height = 7)
