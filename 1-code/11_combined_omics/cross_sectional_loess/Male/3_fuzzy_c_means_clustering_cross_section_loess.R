...
###load("data)
load(
  "3-data_analysis/combined_omics/data_preparation/Male/cross_section_loess/object_cross_section_loess"
)

dir.create(
  "3-data_analysis/combined_omics/Male/fuzzy_c_means_clustering/cross_section_loess/",
  recursive = TRUE
)

setwd("3-data_analysis/combined_omics/Male/fuzzy_c_means_clustering/cross_section_loess")
