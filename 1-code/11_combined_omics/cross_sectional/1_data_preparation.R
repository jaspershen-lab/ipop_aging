...
###load("data)
load(
  "3-data_analysis/plasma_transcriptome/data_preparation/object_cross_section"
)
...
dir.create("3-data_analysis/combined_omics/data_preparation/cross_section",
           recursive = TRUE)

setwd("3-data_analysis/combined_omics/data_preparation/cross_section")
