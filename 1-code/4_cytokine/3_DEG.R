...
dir.create("3-data_analysis/plasma_cytokine/DEG/cross_section_loess/",
           recursive = TRUE)

setwd("3-data_analysis/plasma_cytokine/DEG/cross_section_loess")
...
plot1 <-
  ...
  labs(x = "", y = "") +
  scale_fill_manual(values = c("changed" = unname(omics_color["cytokine"]),
                               "no" = "grey")) +
