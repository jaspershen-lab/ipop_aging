...
dir.create("3-data_analysis/oral_microbiome/data_preparation/same_samples", recursive = TRUE)
setwd("3-data_analysis/oral_microbiome/data_preparation/same_samples")
