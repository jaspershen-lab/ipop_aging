...
tony_protein <-
  readxl::read_xlsx("3-data_analysis/tony_NM/protein_waves.xlsx")
...
dir.create(
  "3-data_analysis/plasma_proteomics/protein_waves/compared_with_tony_paper",
  recursive = TRUE
)
setwd("3-data_analysis/plasma_proteomics/protein_waves/compared_with_tony_paper")
