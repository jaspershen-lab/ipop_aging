...
dir.create("3-data_analysis/plasma_proteomics/data_preparation/same_samples",
           recursive = TRUE)
setwd("3-data_analysis/plasma_proteomics/data_preparation/same_samples")
...
cor_data <-
  purrr::map(1:nrow(new_expression_data), function(i) {
    cor(as.numeric(new_expression_data[i,]),
