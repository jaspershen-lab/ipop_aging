...
dir.create(
  "3-data_analysis/plasma_proteomics/fuzzy_c_means_clustering/cross_section_loess/",
  recursive = TRUE
)

setwd("3-data_analysis/plasma_proteomics/fuzzy_c_means_clustering/cross_section_loess")
