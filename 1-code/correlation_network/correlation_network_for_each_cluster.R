...
# load("3-data_analysis/combined_omics/correlation_data/cor_data")

dir.create(
  "3-data_analysis/combined_omics/correlation_network/cross_section_loess",
  recursive = TRUE
)

setwd("3-data_analysis/combined_omics/correlation_network/cross_section_loess")
