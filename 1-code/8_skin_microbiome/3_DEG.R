...
dir.create("3-data_analysis/skin_microbiome/DEG/cross_section_loess/",
           recursive = TRUE)

setwd("3-data_analysis/skin_microbiome/DEG/cross_section_loess")
...
plot1 <-
  ...
  labs(x = "", y = "") +
  scale_fill_manual(values = c("changed" = unname(omics_color["skin_microbiome"]),
                               "no" = "grey")) +
