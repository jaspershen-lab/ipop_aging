...
dir.create("data_analysis/plasma_transcriptome/DEG/cross_section_loess/",
           recursive = TRUE)

setwd("data_analysis/plasma_transcriptome/DEG/cross_section_loess")
...
age_range <-
  object_cross_section_loess@sample_info$adjusted_age %>%
...
#       temp_data <-
#         data.frame(
#           subject_id = object_cross_section_loess@sample_info$subject_id,
#           age_range = factor(
#             object_cross_section_loess@sample_info$age_range,
#             levels = stringr::str_sort(
#               unique(object_cross_section_loess@sample_info$age_range),
#               numeric = TRUE
#             )
#           ),
#           x = x,
...
#     data.frame(
#       p_value,
#       variable_id = object_cross_section_loess@variable_info$variable_id,
#       stringsAsFactors = FALSE
#     )
#   })
#
...
plot1 <-
  ...
  labs(x = "", y = "") +
  scale_fill_manual(values = c("changed" = unname(omics_color["transcriptome"]),
                               "no" = "grey")) +
