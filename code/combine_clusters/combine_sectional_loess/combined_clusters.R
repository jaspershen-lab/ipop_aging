...
###transcriptome
load(
  "data_analysis/plasma_transcriptome/fuzzy_c_means_clustering/cross_section_loess/final_cluster_info"
)
...
transcriptome_data <-
  readr::read_delim(
    "data_analysis/plasma_transcriptome/fuzzy_c_means_clustering/cross_section_loess/temp_data.txt"
  )
...
###proteomics
load(
  "data_analysis/plasma_proteomics/fuzzy_c_means_clustering/cross_section_loess/final_cluster_info"
)
...
proteomics_data <-
  readr::read_delim(
    "data_analysis/plasma_proteomics/fuzzy_c_means_clustering/cross_section_loess/temp_data.txt"
  )
...
###metabolomics
load(
  "data_analysis/plasma_metabolomics/fuzzy_c_means_clustering/cross_section_loess/final_cluster_info"
)
...
metabolomics_data <-
  readr::read_delim(
    "data_analysis/plasma_metabolomics/fuzzy_c_means_clustering/cross_section_loess/temp_data.txt"
  )
...
###cytokine
load(
  "data_analysis/plasma_cytokine/fuzzy_c_means_clustering/cross_section_loess/final_cluster_info"
)
...
cytokine_data <-
  readr::read_delim(
    "data_analysis/plasma_cytokine/fuzzy_c_means_clustering/cross_section_loess/temp_data.txt"
  )
...
###clinical_test
load(
  "data_analysis/clinical_test/fuzzy_c_means_clustering/cross_section_loess/final_cluster_info"
)
...
clinical_test_data <-
  readr::read_delim(
    "data_analysis/clinical_test/fuzzy_c_means_clustering/cross_section_loess/temp_data.txt"
  )
...
###lipidomics
load(
  "data_analysis/plasma_lipidomics/fuzzy_c_means_clustering/cross_section_loess/final_cluster_info"
)
...
lipidomics_data <-
  readr::read_delim(
    "data_analysis/plasma_lipidomics/fuzzy_c_means_clustering/cross_section_loess/temp_data.txt"
  )
...
###gut_microbiome
load(
  "data_analysis/gut_microbiome/fuzzy_c_means_clustering/cross_section_loess/final_cluster_info"
)
...
gut_microbiome_data <-
  readr::read_delim(
    "data_analysis/gut_microbiome/fuzzy_c_means_clustering/cross_section_loess/temp_data.txt"
  )
...
###skin_microbiome
load(
  "data_analysis/skin_microbiome/fuzzy_c_means_clustering/cross_section_loess/final_cluster_info"
)
...
skin_microbiome_data <-
  readr::read_delim(
    "data_analysis/skin_microbiome/fuzzy_c_means_clustering/cross_section_loess/temp_data.txt"
  )
...
###oral_microbiome
load(
  "data_analysis/oral_microbiome/fuzzy_c_means_clustering/cross_section_loess/final_cluster_info"
)
...
oral_microbiome_data <-
  readr::read_delim(
    "data_analysis/oral_microbiome/fuzzy_c_means_clustering/cross_section_loess/temp_data.txt"
  )
...
###nasal_microbiome
load(
  "data_analysis/nasal_microbiome/fuzzy_c_means_clustering/cross_section_loess/final_cluster_info"
)
...
nasal_microbiome_data <-
  readr::read_delim(
    "data_analysis/nasal_microbiome/fuzzy_c_means_clustering/cross_section_loess/temp_data.txt"
  )
...
dir.create("data_analysis/combined_clusters/cross_section_loess/",
           recursive = TRUE)

setwd("data_analysis/combined_clusters/cross_section_loess/")
