...
load(
  "data_analysis/plasma_proteomics/data_preparation/object_cross_section_loess"
)

dir.create(
  "data_analysis/plasma_proteomics/correlation_with_age/cross_section/",
  recursive = TRUE
)

dir.create(
  "data_analysis/plasma_proteomics/correlation_with_age/cross_section_loess/",
  recursive = TRUE
)

setwd("data_analysis/plasma_proteomics/correlation_with_age")
