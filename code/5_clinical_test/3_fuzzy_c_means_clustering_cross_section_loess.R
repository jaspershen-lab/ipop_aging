...
dir.create(
  "data_analysis/clinical_test/fuzzy_c_means_clustering/cross_section_loess",
  recursive = TRUE
)

setwd("data_analysis/clinical_test/fuzzy_c_means_clustering/cross_section_loess")
