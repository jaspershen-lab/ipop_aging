...
dir.create("data_analysis/plasma_cytokine/data_preparation/same_samples",recursive = TRUE)
setwd("data_analysis/plasma_cytokine/data_preparation/same_samples")
