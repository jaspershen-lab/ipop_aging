...
dir.create(
  "data_analysis/plasma_metabolomics/data_preparation/metabolite/same_samples",
  recursive = TRUE
)
setwd("data_analysis/plasma_metabolomics/data_preparation/metabolite/same_samples")
