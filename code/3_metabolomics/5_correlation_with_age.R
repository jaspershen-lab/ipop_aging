...
dir.create(
  "data_analysis/plasma_metabolomics/correlation_with_age/cross_section/",
  recursive = TRUE
)

dir.create(
  "data_analysis/plasma_metabolomics/correlation_with_age/cross_section_loess/",
  recursive = TRUE
)

setwd("data_analysis/plasma_metabolomics/correlation_with_age")
