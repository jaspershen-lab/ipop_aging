...
dir.create("data_analysis/plasma_metabolomics/linear_spearman_feature/cross_section/",
           recursive = TRUE)

setwd("data_analysis/plasma_metabolomics/linear_spearman_feature/cross_section")
