...
dir.create("data_analysis/oral_microbiome/data_preparation/same_samples", recursive = TRUE)
setwd("data_analysis/oral_microbiome/data_preparation/same_samples")
