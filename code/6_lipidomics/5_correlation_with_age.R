...
###load("data)
load(
  "data_analysis/plasma_lipidomics/data_preparation/object_cross_section"
)
load(
  "data_analysis/plasma_lipidomics/data_preparation/object_cross_section_loess"
)

dir.create(
  "data_analysis/plasma_lipidomics/correlation_with_age/cross_section/",
  recursive = TRUE
)

dir.create(
  "data_analysis/plasma_lipidomics/correlation_with_age/cross_section_loess/",
  recursive = TRUE
)

setwd("data_analysis/plasma_lipidomics/correlation_with_age")
