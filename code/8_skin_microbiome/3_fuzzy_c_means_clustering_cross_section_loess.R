...
dir.create(
  "data_analysis/skin_microbiome/fuzzy_c_means_clustering/cross_section_loess/",
  recursive = TRUE
)

setwd("data_analysis/skin_microbiome/fuzzy_c_means_clustering/cross_section_loess")
