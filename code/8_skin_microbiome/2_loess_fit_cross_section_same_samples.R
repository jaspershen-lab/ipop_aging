...
dir.create("data_analysis/skin_microbiome/data_preparation/same_samples", recursive = TRUE)
setwd("data_analysis/skin_microbiome/data_preparation/same_samples")
