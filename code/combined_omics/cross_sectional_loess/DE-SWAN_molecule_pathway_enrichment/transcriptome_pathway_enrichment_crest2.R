...
####transcriptome
dir.create("transcriptome_pathway_crest2")
dir.create("transcriptome_pathway_crest2/GO_result/")
dir.create("transcriptome_pathway_crest2/KEGG_result/")
dir.create("transcriptome_pathway_crest2/Reactome_result/")
...
#   enrichGO(
#     gene = temp_data_transcriptome_crest2$ENTREZID[!is.na(temp_data_transcriptome_crest2$ENTREZID)],
#     OrgDb = org.Hs.eg.db,
#     keyType = "ENTREZID",
#     ont = "ALL",
#     pvalueCutoff = 0.05,
...
# save(transcriptome_crest2_go, file = "transcriptome_pathway_crest2/GO_result/transcriptome_crest2_go")
...
#   enrichKEGG(
#     gene = temp_data_transcriptome_crest2$UNIPROT[!is.na(temp_data_transcriptome_crest2$UNIPROT)],
#     organism = "hsa",
#     keyType = "uniprot",
#     pvalueCutoff = 0.05,
#     pAdjustMethod = "fdr",
...
#   dplyr::filter(p.adjust < 0.05)
#
# result <- transcriptome_crest2_kegg@result
#
# kegg_class <-
#   purrr::map(
#     .x = result$ID,
...
#   unlist()
#
# transcriptome_crest2_kegg@result$kegg_class <- kegg_class
#
# save(transcriptome_crest2_kegg, file = "transcriptome_pathway_crest2/KEGG_result/transcriptome_crest2_kegg")
load("transcriptome_pathway_crest2/KEGG_result/transcriptome_crest2_kegg")

# ##reactome pathway enrichment
# library(ReactomePA)
# transcriptome_crest2_reactome <-
#   ReactomePA::enrichPathway(gene = temp_data_transcriptome_crest2$ENTREZID[!is.na(temp_data_transcriptome_crest2$ENTREZID)],
#                             organism = "human",
#                             pvalueCutoff = 0.05,
#                             pAdjustMethod = "fdr",
#                             qvalueCutoff = 0.05)
...
# disease <-
#   purrr::map(transcriptome_crest2_reactome@result$ID, function(x) {
...
#   unlist()
#
# transcriptome_crest2_reactome@result$disease <-
#   disease
#
# save(transcriptome_crest2_reactome, file = "transcriptome_pathway_crest2/Reactome_result/transcriptome_crest2_reactome")
...
# go_sim_matrix =
#   get_go_result_sim(result = transcriptome_crest2_go, sim.cutoff = 0)
#
# save(go_sim_matrix, file = "transcriptome_pathway_crest2/GO_result/go_sim_matrix")

load("transcriptome_pathway_crest2/GO_result/go_sim_matrix")
...
#                                                            "sim")))
#
# save(subnetwork, file = "transcriptome_pathway_crest2/GO_result/subnetwork")
load("transcriptome_pathway_crest2/GO_result/subnetwork")
...
# )
#
# saveWorkbook(wb, "transcriptome_pathway_crest2/GO_result/result_go.xlsx", overwrite = TRUE)
...
# ggplot2::ggsave(plot,
#        filename =
#          "transcriptome_pathway_crest2/GO_result/GO_sim_plot.pdf",
#        width = 7,
#        height = 7)

dir.create("transcriptome_pathway_crest2/GO_result/GO_sim_plot")
...
#     plot,
#     filename = file.path(
#       "transcriptome_pathway_crest2/GO_result/GO_sim_plot",
...
#     width = 16,
#     height = 14,
#     path = "transcriptome_pathway_crest2/GO_result",
#     top = 15
#   )
# }
...
# )
#
# saveWorkbook(wb, "transcriptome_pathway_crest2/GO_result/result_go_cluster.xlsx", overwrite = TRUE)

###output the cluster annotation for each cluster
dir.create("transcriptome_pathway_crest2/GO_result/GO_graph")
...
#         plot,
#         filename = file.path(
#           "transcriptome_pathway_crest2/GO_result/GO_graph",
...
# kegg_sim_matrix <-
#   simplifyEnrichment::term_similarity_from_KEGG(term_id = c(transcriptome_crest2_kegg$ID),
#                                                 method = "jaccard") %>%
#   as.data.frame() %>%
...
#
# save(kegg_sim_matrix, file = "transcriptome_pathway_crest2/KEGG_result/kegg_sim_matrix")

load("transcriptome_pathway_crest2/KEGG_result/kegg_sim_matrix")
...
node_data <-
  rbind(transcriptome_crest2_kegg) %>%
  as.data.frame() %>%
  dplyr::select(ID, everything()) %>%
  dplyr::rename(node = ID) %>%
...
# save(result_kegg, file = "transcriptome_pathway_crest2/KEGG_result/result_kegg")
load("transcriptome_pathway_crest2/KEGG_result/result_kegg")
...
# ggsave(plot,
#        filename = "transcriptome_pathway_crest2/KEGG_result/kegg_sim_plot.pdf",
#        width = 9,
#        height = 7)


dir.create("transcriptome_pathway_crest2/KEGG_result/KEGG_sim_plot")
...
#     plot,
#     filename = file.path(
#       "transcriptome_pathway_crest2/KEGG_result/KEGG_sim_plot",
#       paste(temp_cluster, "sim_plot.pdf", sep = "_")
#     ),
#     width = 21,
#     height = 7
...
# )
#
# saveWorkbook(wb, "transcriptome_pathway_crest2/KEGG_result/result_kegg_cluster.xlsx", overwrite = TRUE)
...
# reactome_sim_matrix <-
#   tryCatch(
#     expr =  simplifyEnrichment::term_similarity_from_Reactome(term_id = c(transcriptome_crest2_reactome$ID),
#                                                                method = "jaccard") %>%
#       as.data.frame() %>%
#       tibble::rownames_to_column(var = "name1") %>%
#       tidyr::pivot_longer(
...
#   )
#
# save(reactome_sim_matrix, file = "transcriptome_pathway_crest2/Reactome_result/reactome_sim_matrix")

load("transcriptome_pathway_crest2/Reactome_result/reactome_sim_matrix")
...
node_data <-
  rbind(transcriptome_crest2_reactome) %>%
  as.data.frame() %>%
  dplyr::select(ID, everything()) %>%
  dplyr::rename(node = ID)
...
#   dplyr::arrange(p.adjust)
#
# save(result_reactome, file = "transcriptome_pathway_crest2/Reactome_result/result_reactome")
load("transcriptome_pathway_crest2/Reactome_result/result_reactome")
...
# )
#
# saveWorkbook(wb, "transcriptome_pathway_crest2/Reactome_result/result_reactome.xlsx", overwrite = TRUE)
...
# ggsave(plot,
#        filename =
#          "transcriptome_pathway_crest2/Reactome_result/Reactome_sim_plot.pdf",
#        width = 8.5,
#        height = 7)

dir.create("transcriptome_pathway_crest2/Reactome_result/Reactome_sim_plot")
...
#     dplyr::mutate(p.adjust = -log(as.numeric(p.adjust, 10))) %>%
#     dplyr::arrange(p.adjust) %>%
#     dplyr::mutate(Description = masstools::name_duplicated(Description)) %>% 
#     dplyr::mutate(Description = stringr::str_replace(Description, "Homo sapiens\\\r: ", "")) %>% 
#     dplyr::mutate(Description = factor(Description, levels = Description)) %>%
#     ggplot(aes(p.adjust, Description)) +
#     geom_bar(stat = "identity", color = "grey") +
#     geom_text(
...
#     plot,
#     filename = file.path(
#       "transcriptome_pathway_crest2/Reactome_result/Reactome_sim_plot",
#       paste(temp_cluster, "sim_plot.pdf", sep = "_")
#     ),
#     width = 21,
#     height = 7
...
#   width = 16,
#   height = 12,
#   path = "transcriptome_pathway_crest2/Reactome_result"
# )
...
# saveWorkbook(
#   wb,
#   "transcriptome_pathway_crest2/Reactome_result/result_reactome_cluster.xlsx",
#   overwrite = TRUE
# )
...
result_go_cluster <-
  rbind(
    readxl::read_xlsx(
      "transcriptome_pathway_crest2/GO_result/result_go_cluster.xlsx",
      sheet = 1
    ) %>%
...
saveWorkbook(
  wb,
  "transcriptome_pathway_crest2/KEGG_result/result_kegg_cluster.xlsx",
  overwrite = TRUE
)
...
# save(result_all, file = "transcriptome_pathway_crest2/result_all")
...
# )
# 
# saveWorkbook(wb, "transcriptome_pathway_crest2/result_all.xlsx", overwrite = TRUE)
...
ggsave(plot,
       filename = "transcriptome_pathway_crest2/GO_KEGG_Reactome_sim_plot.pdf",
       width = 6,
       height = 7)
