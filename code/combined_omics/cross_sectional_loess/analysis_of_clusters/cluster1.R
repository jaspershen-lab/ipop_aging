...
dir.create(
  "data_analysis/combined_omics/fuzzy_c_means_clustering/cross_section_loess/cluster_1/",
  recursive = TRUE
)
...
# save(transcriptome_go, file = "transcriptome_pathway/GO_result/transcriptome_go")
load("transcriptome_pathway/GO_result/transcriptome_go")
...
# 
# save(transcriptome_kegg, file = "transcriptome_pathway/KEGG_result/transcriptome_kegg")
load("transcriptome_pathway/KEGG_result/transcriptome_kegg")

# ##reactome pathway enrichment
# library(ReactomePA)
# transcriptome_reactome <-
#   ReactomePA::enrichPathway(gene = temp_data_transcriptome$ENTREZID[!is.na(temp_data_transcriptome$ENTREZID)],
#                             organism = "human",
#                             pvalueCutoff = 0.05,
#                             pAdjustMethod = "fdr",
#                             qvalueCutoff = 0.05)
...
#   disease
# 
# save(transcriptome_reactome, file = "transcriptome_pathway/Reactome_result/transcriptome_reactome")
load("transcriptome_pathway/Reactome_result/transcriptome_reactome")
...
# kegg_sim_matrix <-
#   simplifyEnrichment::term_similarity_from_KEGG(term_id = c(transcriptome_kegg$ID),
#                                                 method = "jaccard") %>%
#   as.data.frame() %>%
...
# reactome_sim_matrix <-
#   tryCatch(
#     expr =  simplifyEnrichment::term_similarity_from_Reactome(term_id = c(transcriptome_reactome$ID),
#                                                                method = "jaccard") %>%
#       as.data.frame() %>%
#       tibble::rownames_to_column(var = "name1") %>%
#       tidyr::pivot_longer(
