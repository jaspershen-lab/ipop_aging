...
dir.create("data_analysis/nasal_microbiome/data_preparation/same_samples", recursive = TRUE)
setwd("data_analysis/nasal_microbiome/data_preparation/same_samples")
