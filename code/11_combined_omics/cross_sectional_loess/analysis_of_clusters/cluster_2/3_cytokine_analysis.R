...
load(
  "data_analysis/plasma_cytokine/data_preparation/object"
)

setwd(
  "data_analysis/combined_omics/fuzzy_c_means_clustering/cross_section_loess/cluster_2/cytokine_pathway/"
)
