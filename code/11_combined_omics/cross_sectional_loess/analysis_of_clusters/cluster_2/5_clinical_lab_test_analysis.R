...
load("data_analysis/clinical_test/data_preparation/object_corss_section")

setwd(
  "data_analysis/combined_omics/fuzzy_c_means_clustering/cross_section_loess/cluster_2/clinical_test_pathway/"
)
