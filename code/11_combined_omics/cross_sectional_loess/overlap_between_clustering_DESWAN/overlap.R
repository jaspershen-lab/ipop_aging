...
cluster_info2 <-
  readxl::read_xlsx(
    "data_analysis/combined_omics/fuzzy_c_means_clustering/cross_section_loess/cluster_2/cluster2.xlsx"
  )

cluster_info4 <-
  readxl::read_xlsx(
    "data_analysis/combined_omics/fuzzy_c_means_clustering/cross_section_loess/cluster_4/cluster4.xlsx"
  )

cluster_info5 <-
  readxl::read_xlsx(
    "data_analysis/combined_omics/fuzzy_c_means_clustering/cross_section_loess/cluster_5/cluster5.xlsx"
  )
...
plot
dir.create("data_analysis/combined_omics/crest_cluster_overlap")
setwd("data_analysis/combined_omics/crest_cluster_overlap")
