...
###load("data)
load(
  "data_analysis/combined_omics/data_preparation/Male/cross_section_loess/object_cross_section_loess"
)

dir.create(
  "data_analysis/combined_omics/Male/fuzzy_c_means_clustering/cross_section_loess/",
  recursive = TRUE
)

setwd("data_analysis/combined_omics/Male/fuzzy_c_means_clustering/cross_section_loess")
