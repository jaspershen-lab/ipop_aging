...
###load("data)
load(
  "data_analysis/plasma_transcriptome/data_preparation/Male/object_cross_section_loess"
)
transcriptome_object <- object_cross_section_loess

load("data_analysis/plasma_proteomics/data_preparation/Male/object_cross_section_loess")
proteomics_object <- object_cross_section_loess

load(
  "data_analysis/plasma_metabolomics/data_preparation/metabolite/Male/object_cross_section_loess"
)
metabolomics_object <- object_cross_section_loess

load("data_analysis/plasma_cytokine/data_preparation/Male/object_cross_section_loess")
cytokine_object <- object_cross_section_loess

load("data_analysis/clinical_test/data_preparation/Male/object_cross_section_loess")
clinical_test_object <- object_cross_section_loess

load("data_analysis/plasma_lipidomics/data_preparation/Male/object_cross_section_loess")
lipidomics_object <- object_cross_section_loess

load("data_analysis/gut_microbiome/data_preparation/Male/object_cross_section_loess")
gut_microbiome_object <- object_cross_section_loess

load("data_analysis/skin_microbiome/data_preparation/Male/object_cross_section_loess")
skin_microbiome_object <- object_cross_section_loess

load("data_analysis/oral_microbiome/data_preparation/Male/object_cross_section_loess")
oral_microbiome_object <- object_cross_section_loess

load("data_analysis/nasal_microbiome/data_preparation/Male/object_cross_section_loess")
nasal_microbiome_object <- object_cross_section_loess

dir.create("data_analysis/combined_omics/data_preparation/Male/cross_section_loess",
           recursive = TRUE)

setwd("data_analysis/combined_omics/data_preparation/Male/cross_section_loess")
