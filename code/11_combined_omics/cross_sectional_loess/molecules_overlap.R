...
###load("data)
{
  ...
  load(
    "data_analysis/plasma_proteomics/linear_spearman/cross_section/variable_info"
  )
  ...
  load(
    "data_analysis/plasma_lipidomics/linear_spearman/cross_section/variable_info"
  )
...
dir.create("data_analysis/combined_omics/molecules_crest_linear_overlap",
           recursive = TRUE)

setwd("data_analysis/combined_omics/molecules_crest_linear_overlap")
