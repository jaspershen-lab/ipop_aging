...
###load("data)
load(
  "data_analysis/plasma_transcriptome/linear_spearman/cross_section/variable_info"
)
...
load("data_analysis/plasma_proteomics/linear_spearman/cross_section/variable_info")
proteomics_variable_info <-
  variable_info %>%
  dplyr::mutate(mol_name = variable_id)

load(
  "data_analysis/plasma_metabolomics/linear_spearman/cross_section/variable_info"
)
metabolomics_variable_info <-
  variable_info %>%
  dplyr::mutate(mol_name = Compound.name)

load("data_analysis/plasma_cytokine/linear_spearman/cross_section/variable_info")
cytokine_variable_info <-
  variable_info %>%
  dplyr::mutate(mol_name = SYMBOL)

load("data_analysis/clinical_test/linear_spearman/cross_section/variable_info")
clinical_test_variable_info <-
  variable_info %>%
  dplyr::mutate(mol_name = test_name)

load("data_analysis/plasma_lipidomics/linear_spearman/cross_section/variable_info")
lipidomics_variable_info <-
  variable_info %>%
  dplyr::mutate(mol_name = variable_id)

load("data_analysis/gut_microbiome/linear_spearman/cross_section/variable_info")
gut_microbiome_variable_info <-
  variable_info %>%
  dplyr::mutate(mol_name = Genus)

load("data_analysis/skin_microbiome/linear_spearman/cross_section/variable_info")
skin_microbiome_variable_info <-
  variable_info %>%
  dplyr::mutate(mol_name = Genus)

load("data_analysis/oral_microbiome/linear_spearman/cross_section/variable_info")
oral_microbiome_variable_info <-
  variable_info %>%
  dplyr::mutate(mol_name = Genus)

load("data_analysis/nasal_microbiome/linear_spearman/cross_section/variable_info")
...
dir.create("data_analysis/combined_omics/linear_spearman_marker",
           recursive = TRUE)

setwd("data_analysis/combined_omics/linear_spearman_marker")
...
7106/8556, 240/302, 711/814, 22/66, 25/46, 430/846, 127/158, 195/205, 98/104, 206/208
