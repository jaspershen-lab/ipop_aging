...
###load("data)
load(
  "data_analysis/combined_omics/data_preparation/cross_section/object_cross_section"
)

dir.create("data_analysis/combined_omics/mci/cross_section/",
           recursive = TRUE)

setwd("data_analysis/combined_omics/mci/cross_section/")
