...
###transcriptome
load(
  "data_analysis/plasma_transcriptome/correlation_with_age/cross_section/cor_data"
)
load(
  "data_analysis/plasma_transcriptome/correlation_with_age/cross_section_loess/cor_data_loess"
)
...
###proteomics
load("data_analysis/plasma_proteomics/correlation_with_age/cross_section/cor_data")
load(
  "data_analysis/plasma_proteomics/correlation_with_age/cross_section_loess/cor_data_loess"
)
proteomics_cor_data <-
...
###metabolomics
load(
  "data_analysis/plasma_metabolomics/correlation_with_age/cross_section/cor_data"
)
load(
  "data_analysis/plasma_metabolomics/correlation_with_age/cross_section_loess/cor_data_loess"
)
...
###cytokine
load("data_analysis/plasma_cytokine/correlation_with_age/cross_section/cor_data")
load(
  "data_analysis/plasma_cytokine/correlation_with_age/cross_section_loess/cor_data_loess"
)
cytokine_cor_data <-
...
###clinical_test
load("data_analysis/clinical_test/correlation_with_age/cross_section/cor_data")
load(
  "data_analysis/clinical_test/correlation_with_age/cross_section_loess/cor_data_loess"
)
...
###lipidomics
load("data_analysis/plasma_lipidomics/correlation_with_age/cross_section/cor_data")
load(
  "data_analysis/plasma_lipidomics/correlation_with_age/cross_section_loess/cor_data_loess"
)
lipidomics_cor_data <-
...
###gut_microbiome
load("data_analysis/gut_microbiome/correlation_with_age/cross_section/cor_data")
load(
  "data_analysis/gut_microbiome/correlation_with_age/cross_section_loess/cor_data_loess"
)
...
###skin_microbiome
load("data_analysis/skin_microbiome/correlation_with_age/cross_section/cor_data")
load(
  "data_analysis/skin_microbiome/correlation_with_age/cross_section_loess/cor_data_loess"
)
...
###oral_microbiome
load("data_analysis/oral_microbiome/correlation_with_age/cross_section/cor_data")
load(
  "data_analysis/oral_microbiome/correlation_with_age/cross_section_loess/cor_data_loess"
)
...
###nasal_microbiome
load("data_analysis/nasal_microbiome/correlation_with_age/cross_section/cor_data")
load(
  "data_analysis/nasal_microbiome/correlation_with_age/cross_section_loess/cor_data_loess"
)
...
dir.create("data_analysis/combined_omics/correlation_comparison",
           recursive = TRUE)

setwd("data_analysis/combined_omics/correlation_comparison")
